	...
	new Promise((resolve,reject) => {
		...
		.then(user => {
			...
			const mailOptions = {
                ...
                If you are viewing this mail from a Android Device click this <a href="https://play.google.com/store/apps/details?id=com.apurv_studio.app&hl=en">link</a>. 
		...
		.catch(err => {
			console.log(err);
			reject({status:500, message: 'Internal Srver Error !'});
		});
	});
